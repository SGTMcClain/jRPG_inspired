...
public class DisplayInventory : MonoBehaviour
{
    ...
    public int Y_SPACE_BETWEEN_ITMES;
    ...
    public void CreateDisplay()
    {
        for (int i = 0; i < inventory.Container.Count; i++)
        {
            ...
            // "n0" formats a number with commas 
    ...
    {
        return new Vector2(X_START + (X_SPACE_BETWEEN_ITEMS * (i % NUMBER_OF_COLUMNS)), Y_START + (-Y_SPACE_BETWEEN_ITMES * (i / NUMBER_OF_COLUMNS)));
    }
